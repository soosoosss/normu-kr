        ...
        {showAbout && (
          <div className="pi" style={{ 
            ...
            <div style={{ fontSize: 13, color: "#64748B", marginBottom: 24 }}>
              진단 → 개선 → 채용 → 평가 → 기록 → 성장의 선순환 생태계
            </div>
            
            <div style={{ fontSize: 14, color: "#475569", lineHeight: 1.9, marginBottom: 24 }}>
              대한민국 <strong style={{ color: "#EF4444" }}>300만 소상공인 사업장</strong>과 
              <strong style={{ color: "#10B981" }}> 수백만 알바·근로자</strong>를 위한 통합 플랫폼입니다.
              <br/><br/>
              2023년 과태료 19만 건, 임금체불 1조원의 대부분은 <strong>"몰라서"</strong> 발생합니다. 
              하지만 기존 시스템은 <strong>"사후 처벌"</strong>에만 집중합니다.
              <br/><br/>
              <strong style={{ color: "#1E293B" }}>NORMU는 다릅니다. 처벌이 아닌 예방, 감독이 아닌 셀프 개선의 플랫폼입니다.</strong>
            </div>

            <div style={{ background: "#FEF3C7", borderRadius: 12, padding: "20px 24px", marginBottom: 24 }}>
              <div style={{ fontSize: 16, fontWeight: 700, color: "#D97706", marginBottom: 12 }}>
                🔄 NORMU 생태계: 한 곳에서 모든 것
              </div>
              <div style={{ fontSize: 13, color: "#78350F", lineHeight: 1.8 }}>
                <strong>① 진단</strong>: 고용부 300만 레코드 × 근로감독관 지식 × AI 분석<br/>
                <strong>② 예상 평점</strong>: "현재 당신의 예상 평점 ⭐ 3.2/5.0" (셀프 감독)<br/>
                <strong>③ 개선</strong>: 계약서 자동 생성, 위반 사항 구체적 가이드<br/>
                <strong>④ 채용</strong>: 동네 기반 알바 구인/구직 (김사장넷 통합)<br/>
                <strong>⑤ 평가</strong>: 사장 ↔ 알바 양방향 평점 (신뢰도 확보)<br/>
                <strong>⑥ 기록</strong>: 모든 경험을 NCS 능력단위로 체계화
              </div>
            </div>

            <div style={{ background: "#DBEAFE", borderRadius: 12, padding: "20px 24px", marginBottom: 24 }}>
              <div style={{ fontSize: 16, fontWeight: 700, color: "#1E40AF", marginBottom: 12 }}>
                💡 셀프 감독 시스템: 공개 전 미리 알려드립니다
              </div>
              <div style={{ fontSize: 13, color: "#1E3A8A", lineHeight: 1.8 }}>
                사장님이 진단을 완료하면:<br/>
                <br/>
                <strong>"현재 귀하의 예상 평점: ⭐ 2.8/5.0"</strong><br/>
                ⚠️ 최저임금 위반 → 평점 -1.2 예상<br/>
                ⚠️ 계약서 미작성 → 신뢰도 하락<br/>
                ✅ 이렇게 개선하면 ⭐ 4.5까지 상승 가능
                <br/><br/>
                → 평점이 공개되기 전에 미리 보여줘서 <strong>자발적 개선 유도</strong><br/>
                → 근로감독관이 오기 전에 스스로 법 준수
              </div>
            </div>

            <div style={{ background: "#F0FDF4", borderRadius: 12, padding: "20px 24px", marginBottom: 24 }}>
              <div style={{ fontSize: 16, fontWeight: 700, color: "#15803D", marginBottom: 12 }}>
                🎓 NCS 연계: 알바 경험의 가치를 인정합니다
              </div>
              <div style={{ fontSize: 13, color: "#166534", lineHeight: 1.8 }}>
                <strong>근로자 입장:</strong><br/>
                "카페 알바 6개월" → NCS 능력단위 자동 매핑<br/>
                └ 고객응대 (NCS 2401020101_16v2)<br/>
                └ 음료조리 (NCS 1301010208_14v3)<br/>
                └ 위생관리 (NCS 0902010103_15v4)<br/>
                <br/>
                <strong>사장 입장:</strong><br/>
                "홀서빙 구함" → NCS 능력단위로 명시<br/>
                └ 필수: 고객응대, 서빙<br/>
                └ 우대: POS 사용 경험<br/>
                <br/>
                → <strong>기존 사각지대</strong>였던 소소한 알바 경험을 체계적으로 기록<br/>
                → 다음 채용 시 실제 역량 기반 평가 가능<br/>
                → 이력서에 못 쓰던 경험이 <strong>공식 경력</strong>으로 인정
              </div>
            </div>

            <div style={{ background: "#FEF2F2", borderRadius: 12, padding: "20px 24px", marginBottom: 24 }}>
              <div style={{ fontSize: 16, fontWeight: 700, color: "#DC2626", marginBottom: 12 }}>
                🎯 왜 다른 플랫폼이 아닌 NORMU인가?
              </div>
              <div style={{ fontSize: 13, color: "#991B1B", lineHeight: 1.8 }}>
                <strong>기존 알바 플랫폼의 문제:</strong><br/>
                ❌ 계약서 작성 안 함 → 분쟁 발생<br/>
                ❌ 일방적 평가 (사장만 평가) → 블랙 사장 필터링 불가<br/>
                ❌ 경험 기록 없음 → 알바는 경력으로 인정 안 됨<br/>
                ❌ 법적 보호 장치 전무<br/>
                <br/>
                <strong>NORMU의 해결:</strong><br/>
                ✅ 채용 즉시 법 준수 계약서 자동 생성<br/>
                ✅ 양방향 평점 (사장도 평가받음) → 셀프 감독<br/>
                ✅ NCS 기반 경험 체계화 → 이력서 활용<br/>
                ✅ 진단부터 신고까지 전 과정 지원<br/>
                <br/>
                → <strong>알바도 안전하고, 사장도 법 위반 안 하는 선순환 생태계</strong>
              </div>
            </div>

            <div style={{ background: "#F1F5F9", borderRadius: 12, padding: "20px 24px", marginBottom: 16 }}>
              <div style={{ fontSize: 16, fontWeight: 700, color: "#475569", marginBottom: 12 }}>
                🚀 향후 확장: 직업계고 실습 플랫폼
              </div>
              <div style={{ fontSize: 13, color: "#334155", lineHeight: 1.8 }}>
                특성화고·마이스터고 학생들의 <strong>안전한 현장실습 매칭</strong><br/>
                <br/>
                ✅ 검증된 사업장만 매칭 (평점 4.0 이상)<br/>
                ✅ 실습 계약서 자동 생성 (법적 보호)<br/>
                ✅ 실습 경험 NCS로 자동 기록<br/>
                ✅ 졸업 후 포트폴리오로 활용<br/>
                <br/>
                → 학생 실습의 질 향상 + 우수 사업장 발굴<br/>
                <br/>
                <strong>오야지넷 🏗️</strong>: 건설업 특화 (하도급법, 건설근로자법)<br/>
                <strong>AI 실시간 상담 🤖</strong>: 감독관급 답변 + 법령 개정 알림
              </div>
            </div>

            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 12, color: "#64748B", marginBottom: 8 }}>
                📧 사업 문의: contact@normu.kr | 🔬 정책연구 협력 환영
              </div>
